...
export class BakehouseStack extends Stack {
  constructor (scope, id, props) {
    ...
    //Grant lambdas access to DynamoDB
    ...
    usersApi.addMethod('GET', new apigw.LambdaIntegration(postUsersLambda))
    
    //Login
    const loginApi = api.root.addResource('login')
    loginApi.addMethod('GET', new apigw.LambdaIntegration(loginLambda))
